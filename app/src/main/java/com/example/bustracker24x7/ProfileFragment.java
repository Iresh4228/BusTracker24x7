...
//        });
    ...
    private void loadProfile(FirebaseUser user) {
        ...
        dbRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Passenger passenger = snapshot.child("Passengers").child(uid).getValue(Passenger.class);
                txtname.setText(passenger.getPas_name());
                txtemail.setText(passenger.getPas_email());
                txtphone.setText(passenger.getPas_phone());
                txtaddress.setText(passenger.getPas_address());
    ...
    private void saveProfile(FirebaseUser user) {
        ...
        if ((name.equals("") || email.equals("")||phone.equals("")||address.equals(""))){
            ...
            passenger.setPas_id(uid);
            passenger.setPas_name(name);
            passenger.setPas_email(email);
            passenger.setPas_phone(phone);
            passenger.setPas_address(address);

            dbRef.child("Passengers").child(uid).setValue(passenger, new DatabaseReference.CompletionListener() {
                @Override
